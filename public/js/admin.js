...
function handleSocketClose() {
  console.log('WebSocket fechado. Tendando reconectar em 5 segundos...');
...
function handleDrawClick() {
  const confirmationCode = generateCode(5);
  ...
  if (socket.readyState === WebSocket.OPEN) {
    ...
    console.warn('WebSocket não está aberto. Aguarde e tente em instantes.');
  }
}
